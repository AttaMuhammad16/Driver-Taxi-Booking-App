                        ...
                        authViewModel.registerUser(email,password){authResult->
                            if (authResult is MyResult.Error){
                                ...
                                lifecycleScope.launch {
                                    ...
                                    val model=DriverModel(null,listOfUrls,profileDownloadUrl,userName, email, password, phoneNumber, address,0.0,0.0,"",carDetails,0,0, availabe = false, verificationProcess = false)
